...
# It ignores all the lines before the Date in the header Wessex Laboratory Exception Report for DATE
...
BEGIN { OFS="</td><td>"; OFS2="</td><td class=\"critical\">"; \
	...
	/202[1-5]$/ && FILENAME!=ARGV[0] && FILENAME!=ARGV[1]	{ start++; next; }	# sets start to 1 on detecting WESSEX - LABORATORY EXCEPTION REPORT for 26/11/2021. We will now read all subsequent lines
