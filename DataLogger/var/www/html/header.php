    ...
    <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container-fluid">
		...
		<li <?php echo (($page == 'loads') ? 'class=active' : ''); ?> class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li><a href="loads.php">Customer 1</a></li>
                    <li><a href="loads_misc.php">Customer 2</a></li>
                 </ul>
                </li>
		...
		<li class="dropdown">
			...
			<ul class="dropdown-menu">
				...
				<li><button class="btn btn-link" value="printCustomer">Customer Del Notes</button></li>
