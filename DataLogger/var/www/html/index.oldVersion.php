<?php
 ...
 // scripts for all images
 shell_exec('./volumesHomePage.sh; ./storageToTable.sh; ./averageFlowRate.sh 30');

 // one script per accordion
 $panel = shell_exec('./overviewPanel.sh');
 $tankSummary = shell_exec('./overviewStorage.sh');
 $lastLoads = shell_exec('./overviewLoads.sh');
 $gateAccess = shell_exec('./overviewGate.sh');
 $calloff = shell_exec('./overviewCalloff.sh');
 $tankerCIP = shell_exec('./overviewCIP.sh');

 // one shell script for the forecast data which returns an array and also execute the plotting of the graph
 // this should be quicker then multiple shellscripts below
  $forecastData = shell_exec('./getForecastData.sh');
 // THIS HAS BEEN SUPERSEEDED, it did calculate the flowrate based on a number of x days
 // $forecastData = shell_exec('./getForecastDataDaily.sh 5');
 $data = explode("\n", $forecastData);
 $startforecast = $data[0];
 $currenttankers = $data[1];
 $buffer = $data[2];
 $flowrate = $data[3];
 $maxbuffer =$data[4];
...
<div class="container-fluid" style="margin-top:10px">
	...
	<div id="accordion">
                <div id="panel">
                        <h3>Latest Panel Data</h3>
                        <div><pre><?php echo "$panel";?></pre></div>
                </div>
		...
		<div id="storage">
			...
			<div class="row centered">
				...
				<div class="col-md-6" style="margin-top:0.3em">
					<div class="row centered">
						<div class="col-xs-5 col-xs-offset-1" style="margin-top:0.7em">
					...
					<img id="tankSummary" src="/images/tank_summary.svg" class="img-responsive center-block" alt=""/>
				</div>
				<div class="col-md-6"><div class="text-center"><pre style="display: inline-block;"><?php echo "$tankSummary";?></pre></div></div>
			</div>
		</div>

                <div id="loads">
                        <h3>Last 15 Collected Loads</h3>
                        <div><pre><?php echo "$lastLoads";?></pre></div>
                </div>


<!--		<div>
			<h3>Gate Access AJAX</h3>
			<div id="gateList"></div>
		</div>
-->
		...
		<div id="gate">
			...
			<div><pre><?php echo "$gateAccess";?></pre></div>
		</div>
		...
		<div id="forecast">
			...
			<div class="container-fluid myform">
						...
						<form id="forecastForm" class="form-horizontal">
					                ...
					                <div class="form-group">
			        		                ...
			        		                <div class="col-sm-6"><input type="text" class="form-control" id="buffer" name="buffer"
                        					        value=<?php echo "$buffer";?> placeholder="Buffer (m3)">
			                        		</div>
					                </div>
					                <div class="form-group">
                        					...
                        					<div class="col-sm-6"><input type="text" class="form-control" id="maxbuffer" name="maxbuffer"
			        		                        value=<?php echo "$maxbuffer"; ?> placeholder="Max buffer">
                	        				</div>
				        	        </div>
					                <div class="form-group">
					                ...
					                <div class="form-group">
					                        ...
					                        <div class="col-sm-3">
                        					        <input type="text" class="form-control" id="ecoFillOn" name="ecoFillOn" value="23" placeholder="On hour (24)">
								</div>
				                	        <div class="col-sm-3">
                        					        <input type="text" class="form-control" id="ecoFillOff" name="ecoFillOff" value="18" placeholder="Off hour (24)">
				                	        </div>
					                </div>
					                <div class="form-group">
				...
				<div class="row">
					<img id="graph" class="img-responsive center-block" src="images/forecast.svg" alt=""/>
				</div>
				<div class="row">
				...
				<div class="row">
					<img id="frGraph" class="img-responsive center-block" src="images/fr.svg" alt=""/>
				</div>
		...
		<div id="volume">
                        ...
                        <div>
				<img class="img-responsive center-block" src="/images/water.svg" alt=""/>
...
?>
				...
				<div class="row centered">
					<div class="col-md-12" style="padding-left:0px">
						<img id="boreElec" class="img-responsive center-block" src="/images/boreholeElec.svg" alt=""/>
					</div>
				</div>
				<div class="row centered">
					<div class="col-md-12" style="padding-left:0px">
						<img id="fillmode" class="img-responsive center-block" src="/images/elec.svg" alt=""/>
					</div>
				</div>
			</div>
		</div>
                ...
                <div id="cip">
                        ...
                        <div><pre><?php echo "$tankerCIP";?></pre></div>
                </div>

		<div id="traffic">
			<h3>Live Traffic</h3>
			<div class="row" style="padding-left:0px">
                		<iframe class="col-lg-6 col-md-6 col-sm-6" style="height:500px; frameborder:0;border:0;"
				...
				<div class="row">
					<div class="col-md-6">
						...
						<a href="http://www.timeview2.net/xdq/Cotswold%20Springs/COTSWOLDS%20SPRING/DODINGTON%20SPRING/IMAGES/1_day_large_channel_2.png" id="flowlink" target="_blank">
							<img class="center-block" id="flowIMG" style="margin-top:10px; width:520px; height:320px;" alt=""
