<?php
 ...
 $output = shell_exec('tableLabResults.sh /'.escapeshellarg(strftime('%Y')));
// $output = shell_exec('tableLabResults.sh /'.escapeshellarg(strftime('%Y')).' 1323'); // restrict number of lines
 ...
 //  $output = shell_exec('tableLabResults.sh');
?>
