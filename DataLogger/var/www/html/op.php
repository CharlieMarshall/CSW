...
?>
		...
		<div id="traffic">
			...
			<div class="row" style="padding-left:0px">
                		<iframe class="col-lg-6 col-md-6 col-sm-6" style="height:500px; border:0;" loading="lazy" src="https://www.google.com/maps/embed?removed_details" allowfullscreen></iframe>
	                	<iframe class="col-lg-6 col-md-6 col-sm-6" style="height:500px; border:0;" loading="lazy" src="https://www.google.com/maps/embed?removed_details" allowfullscreen></iframe>
			</div></div>
		</div>
		<div id="spring">
				...
				<div class="row">
					<div class="col-md-6">
						...
						<table style="margin-left:auto; margin-right:auto;"><tr>
							<td><a href="http://www.timeview2.net/" target="_blank" title="Username: 'username'">CSW</a></td>
						...
						<a href="http://www.timeview2.net/xdq/removed_credentials/1_day_large_channel_2.png" id="flowlink" target="_blank">
							<img class="center-block" id="flowIMG" style="margin-top:10px; width:520px; height:320px;" alt="" loading="lazy"
							src="http://www.timeview2.net/xdq/removed_credentials/1_day_large_channel_2.png">
						</a>
					</div>
					<div class="col-md-6">
