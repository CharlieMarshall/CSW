...
if(isset($_POST["save"])){
        shell_exec('updateLoad.sh '.escapeshellarg($_POST["load"])." ".escapeshellarg($_POST["tankerID"])." "
...
if(isset($_POST["printDel"])){
	shell_exec("printPOD.py ".escapeshellarg($_POST['load'])." ".escapeshellarg($_POST['tankerID'])." ".escapeshellarg($_POST['tankerCert'])." ".escapeshellarg($_POST['seal'])." ".$date." &" );
...
if(isset($_POST["printSample"])){
        shell_exec("printLabel.py ".escapeshellarg($_POST['load'])." &" );
}
